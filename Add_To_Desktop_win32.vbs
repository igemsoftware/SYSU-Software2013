...
oShellLink.TargetPath = createobject("Scripting.FileSystemObject").GetFolder(".").Path +"\CAST_Designer_win32.exe"  'target
oShellLink.Arguments = "" '
oShellLink.WindowStyle = 7 '1 activative，3 max window，7 min window
oShellLink.Hotkey = ""  '
oShellLink.IconLocation = createobject("Scripting.FileSystemObject").GetFolder(".").Path +"\CAST_Designer_win32.exe, 0"  'icon
